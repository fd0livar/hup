...
import appdirs
from flib.base import pkg, stack
from flib.typing import check
from flib.typing import IterAny, OptStrDict
from flib.typing import PathLikeList, OptStr, OptStrOrBool, OptPathLike
from flib.typing import PathLike, StrDict, StrDictOfPaths
...
def get_var(
        varname: str, *args: Any,
        pkgname: OptStr = None, **kwds: Any) -> OptStr:
    ...
    Args:
        ...
        *args: Optional arguments that specify the application, as required by
            the function :func:`~flib.base.env.update_vars`.
        pkgname:
        **kwds: Optional keyword arguments that specify the application, as
            required by the function :func:`~flib.base.env.update_vars`.
...
def get_vars(*args: Any, pkgname: OptStr = None, **kwds: Any) -> StrDict:
    ...
    Args:
        *args: Optional arguments that specify the application, as required by
            :func:`~flib.base.env.update_vars`.
        **kwds: Optional keyword arguments that specify the application, as
            required by :func:`~flib.base.env.update_vars`.
...
def get_dir(
        dirname: str, *args: Any, pkgname: OptStr = None,
...
def update_dirs(
        ...
        version: OptStr = None, pkgname: OptStr = None, **kwds: Any) -> None:
...
def expand(
        *args: NestPath, udict: OptStrDict = None,
        pkgname: OptStr = None, envdirs: bool = True) -> pathlib.Path:
...
def get_dirname(*args: NestPath, pkgname: OptStr = None) -> str:
...
def basename(*args: NestPath, pkgname: OptStr = None) -> str:
...
def is_dir(path: NestPath, pkgname: OptStr = None) -> bool:
    ...
    return expand(path, pkgname=pkgname).is_dir()
...
def copytree(
        source: NestPath, target: NestPath, pkgname: OptStr = None) -> None:
...
def touch(
        ...
        exist_ok: bool = True, pkgname: OptStr = None) -> bool:
