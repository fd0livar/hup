...
from flib import errors
from flib.base import abc
from flib.typing import check
from flib.typing import OptClassInfo, TypeHint, OptStr, OptStrDict, OptType
from flib.typing import StrDict, StrList, void, OptDict, OptBool
...
class Attribute(property, abc.Isolated):
    ...
    Args:
        ...
        dtype: Data type definition of the attribute given as a type or a tuple
            ...
            :class:`~flib.errors.InvalidTypeError` is raised. By default type
