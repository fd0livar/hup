...
import weakref
from hup.base import abc, attrib, literal
from hup.errors import FileFormatError, ColumnLookupError
from hup.io import plain, FileRef, FileRefClassInfo, FileConnector, FileProxy
from hup.typing import check, OptInt, OptIntTuple, OptStr, StrList
from hup.typing import IntTuple, OptList, OptStrTuple, Iterator
from hup.typing import ErrStack, ErrMeta, ErrType, StrDict, FileLike, StrTuple
...
class File(attrib.Group):
    ...
    def open(self, mode: str = 'r', columns: OptColumns = None) -> HandlerBase:
        ...
        Returns:
            ...
            of the class :class:`~hup.io.csv.Reader` is returned and in
            writing mode (if mode contains the character `r`) an instance of the
            class :class:`~hup.io.csv.Writer` is returned.
...
def load(
    ...
    Returns:
        Instance of class :class:`hup.io.csv.File`
