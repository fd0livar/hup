...
from hup.errors import DirNotEmptyError, FileNotGivenError
from hup.io import abc
from hup.typing import BinaryFileLike, BytesLike, OptBytes, OptStr
from hup.typing import OptPathLike
from hup.typing import PathLike, PathLikeList, ErrMeta, ErrType, ErrStack
from hup.typing import FileLike, StrList, OptPath, AnyOp
...
class File:
    ...
    def get_file_accessor(self, path: PathLike) -> abc.Connector:
        ...
        Returns:
            :class:`File accessor <hup.io.abc.Connector>` to ZipFile
            member.
