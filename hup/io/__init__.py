...
from hup.base.abc import Proxy
from hup.errors import PullError, PushError, ConnectError, DisconnectError
from hup.typing import Iterator, PathLike, FileLike, OptStr
from hup.typing import ErrMeta, ErrType, ErrStack, BinaryFileLike
from hup.typing import TextFileLike
from hup.io.abc import Connector
...
class FileInfo:
    ...
    Args:
        file: :term:`File reference` to a :term:`file object`. The reference can
            ...
            :class:`~hup.io.abc.Connector` or an opened file object in
...
def openx(file: FileRef, *args: Any, **kwds: Any) -> Iterator[FileLike]:
    ...
    Args:
        file: :term:`File reference` that points to a valid filename in the
            ...
            instance of the class :class:`~hup.io.abc.Connector`.
        mode: String, which characters specify the mode in which the file stream
