...
Hup is a multi-purpose Python library, which primarily aims to support projects
at Frootlab by a common base library. The majority of the comprised modules,
however, is kept generic and well documented, to facilitate their application in
...
__description__ = 'Hup'
__url__ = 'https://www.frootlab.org/hup'
