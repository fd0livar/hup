...
from hup import errors
from hup.base import abc
from hup.typing import check
from hup.typing import OptClassInfo, TypeHint, OptStr, OptStrDict, OptType
from hup.typing import StrDict, StrList, void, OptDict, OptBool
...
class Attribute(property, abc.Isolated):
    ...
    Args:
        ...
        dtype: Data type definition of the attribute given as a type or a tuple
            ...
            :class:`~hup.errors.InvalidTypeError` is raised. By default type
...
class Group(abc.Isolated):
    ...
    Args:
        parent: Reference to logical parent :class:'attribute group
            <.attrib.Group>', which is used for inheritance and
